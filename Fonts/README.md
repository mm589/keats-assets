...
<li>On your KEATS pages, reference each individual font separately in your HTML code. You may reference the font format using inline CSS, <code><style></code> tags and @-rules.</p></li>
      <li><b>If using the currently available font files in this repository:</b> The font files (archived and current as of 2018) are available in this repository, so you can serve each file using the current URL in KEATS, or if that's no longer practical, use a CDN or web server of your choice.</li>
</ol>
